import { n as __commonJS, t as require_react } from "./react-s_wQR8gN.js";
	...
	(function() {
		...
		*/
		...
		function getMaskedContext(workInProgress$1, unmaskedContext) {
			...
			checkPropTypes(contextTypes, context, "context", getComponentNameFromFiber(workInProgress$1) || "Unknown");
		...
		*/
		...
		function ChildReconciler(shouldTrackSideEffects) {
			...
			function updateFromMap(existingChildren, returnFiber, newIdx, newChild, lanes) {
				...
				if (typeof newChild === "object" && newChild !== null) {
					...
					if (isArray(newChild) || getIteratorFn(newChild)) return updateFragment$1(returnFiber, existingChildren.get(newIdx) || null, newChild, lanes, null);
					throwOnInvalidObjectType(returnFiber, newChild);
				}
				if (typeof newChild === "function") warnOnFunctionType(returnFiber);
				return null;
					...
					while (dependency !== null) {
						if (dependency.context === context) {
							if (fiber.tag === ClassComponent) {
								var update = createUpdate(NoTimestamp, pickArbitraryLane(renderLanes$1));
		...
		function dispatchReducerAction(fiber, queue, action) {
			...
			if (isRenderPhaseUpdate(fiber)) enqueueRenderPhaseUpdate(queue, update);
				...
				if (root$1 !== null) {
					scheduleUpdateOnFiber(root$1, fiber, lane, requestEventTime());
		...
		*/
		...
		function mountClassInstance(workInProgress$1, ctor, newProps, renderLanes$1) {
			...
			else instance.context = getMaskedContext(workInProgress$1, getUnmaskedContext(workInProgress$1, ctor, true));
		...
		function resumeMountClassInstance(workInProgress$1, ctor, newProps, renderLanes$1) {
			...
			else nextContext = getMaskedContext(workInProgress$1, getUnmaskedContext(workInProgress$1, ctor, true));
			var getDerivedStateFromProps = ctor.getDerivedStateFromProps;
		...
		function updateOffscreenComponent(current$1, workInProgress$1, renderLanes$1) {
			...
			if (nextProps.mode === "hidden" || enableLegacyHidden) if ((workInProgress$1.mode & ConcurrentMode) === NoMode) {
				...
				pushRenderLanes(workInProgress$1, prevState !== null ? prevState.baseLanes : renderLanes$1);
			}
			else {
		...
		function updateFunctionComponent(current$1, workInProgress$1, Component, nextProps, renderLanes$1) {
			...
			var context = getMaskedContext(workInProgress$1, getUnmaskedContext(workInProgress$1, Component, true));
			var nextChildren;
			var hasId;
			prepareToReadContext(workInProgress$1, renderLanes$1);
			markComponentRenderStarted(workInProgress$1);
		...
		function updateClassComponent(current$1, workInProgress$1, Component, nextProps, renderLanes$1) {
			switch (shouldError(workInProgress$1)) {
				...
				case true:
					...
					workInProgress$1.lanes = mergeLanes(workInProgress$1.lanes, lane);
					enqueueCapturedUpdate(workInProgress$1, createClassErrorUpdate(workInProgress$1, createCapturedValueAtFiber(error$1, workInProgress$1), lane));
					break;
			}
			if (workInProgress$1.type !== workInProgress$1.elementType) {
				var innerPropTypes = Component.propTypes;
		...
		function updateHostRoot(current$1, workInProgress$1, renderLanes$1) {
			...
			if (prevState.isDehydrated) {
				...
				if (workInProgress$1.flags & ForceClientRender) return mountHostRootWithoutHydrating(current$1, workInProgress$1, nextChildren, renderLanes$1, createCapturedValueAtFiber(/* @__PURE__ */ new Error("There was an error while hydrating. Because the error happened outside of a Suspense boundary, the entire root will switch to client rendering."), workInProgress$1));
				else if (nextChildren !== prevChildren) return mountHostRootWithoutHydrating(current$1, workInProgress$1, nextChildren, renderLanes$1, createCapturedValueAtFiber(/* @__PURE__ */ new Error("This root received an early update, before anything was able hydrate. Switched the entire root to client rendering."), workInProgress$1));
				else {
		...
		function mountIndeterminateComponent(_current, workInProgress$1, Component, renderLanes$1) {
			resetSuspendedCurrentOnMountInLegacyMode(_current, workInProgress$1);
			var props = workInProgress$1.pendingProps;
			var context = getMaskedContext(workInProgress$1, getUnmaskedContext(workInProgress$1, Component, false));
			prepareToReadContext(workInProgress$1, renderLanes$1);
			var value;
			var hasId;
			markComponentRenderStarted(workInProgress$1);
		...
		function updateDehydratedSuspenseComponent(current$1, workInProgress$1, didSuspend, nextProps, suspenseInstance, suspenseState, renderLanes$1) {
			if (!didSuspend) {
				...
				if (isSuspenseInstanceFallback(suspenseInstance)) {
					...
					return retrySuspenseComponentWithoutHydrating(current$1, workInProgress$1, renderLanes$1, createCapturedValue(error$1, digest, stack));
				}
				...
				if (didReceiveUpdate || hasContextChanged$1) {
					...
					renderDidSuspendDelayIfPossible();
					return retrySuspenseComponentWithoutHydrating(current$1, workInProgress$1, renderLanes$1, createCapturedValue(/* @__PURE__ */ new Error("This Suspense boundary received an update before it finished hydrating. This caused the boundary to switch to client rendering. The usual way to fix this is to wrap the original update in startTransition.")));
				...
				workInProgress$1.flags &= ~ForceClientRender;
				return retrySuspenseComponentWithoutHydrating(current$1, workInProgress$1, renderLanes$1, createCapturedValue(/* @__PURE__ */ new Error("There was an error while hydrating this Suspense boundary. Switched to client rendering.")));
		...
		function beginWork(current$1, workInProgress$1, renderLanes$1) {
			...
			if (current$1 !== null) if (current$1.memoizedProps !== workInProgress$1.pendingProps || hasContextChanged() || workInProgress$1.type !== current$1.type) didReceiveUpdate = true;
			else {
				...
				if (getIsHydrating() && isForkedChild(workInProgress$1)) {
					...
					pushTreeId(workInProgress$1, getForksAtLevel(), slotIndex);
				}
			}
			workInProgress$1.lanes = NoLanes;
			switch (workInProgress$1.tag) {
				...
				case FunctionComponent:
					...
					return updateFunctionComponent(current$1, workInProgress$1, Component, workInProgress$1.elementType === Component ? unresolvedProps : resolveDefaultProps(Component, unresolvedProps), renderLanes$1);
				case ClassComponent:
					var _Component = workInProgress$1.type;
					var _unresolvedProps = workInProgress$1.pendingProps;
					return updateClassComponent(current$1, workInProgress$1, _Component, workInProgress$1.elementType === _Component ? _unresolvedProps : resolveDefaultProps(_Component, _unresolvedProps), renderLanes$1);
				...
				case ForwardRef:
					...
					return updateForwardRef(current$1, workInProgress$1, type, workInProgress$1.elementType === type ? _unresolvedProps2 : resolveDefaultProps(type, _unresolvedProps2), renderLanes$1);
				...
				case IncompleteClassComponent:
					...
					return mountIncompleteClassComponent(current$1, workInProgress$1, _Component2, workInProgress$1.elementType === _Component2 ? _unresolvedProps4 : resolveDefaultProps(_Component2, _unresolvedProps4), renderLanes$1);
		...
		function completeWork(current$1, workInProgress$1, renderLanes$1) {
			...
			switch (workInProgress$1.tag) {
				...
				case SuspenseComponent:
					...
					if (nextDidTimeout !== (current$1 !== null && current$1.memoizedState !== null)) {
						if (nextDidTimeout) {
		...
		function captureCommitPhaseErrorOnRoot(rootFiber, sourceFiber, error$1) {
			var root$1 = enqueueUpdate(rootFiber, createRootErrorUpdate(rootFiber, createCapturedValueAtFiber(error$1, sourceFiber), SyncLane), SyncLane);
			var eventTime = requestEventTime();
			if (root$1 !== null) {
		...
		function attemptSynchronousHydration$1(fiber) {
			switch (fiber.tag) {
				case HostRoot:
					...
					if (isRootDehydrated(root$1)) flushRoot(root$1, getHighestPriorityPendingLanes(root$1));
					break;
				case SuspenseComponent:
					flushSync(function() {
						var root$2 = enqueueConcurrentRenderForLane(fiber, SyncLane);
						if (root$2 !== null) scheduleUpdateOnFiber(root$2, fiber, SyncLane, requestEventTime());
					});
		...
		function attemptContinuousHydration$1(fiber) {
			...
			if (root$1 !== null) scheduleUpdateOnFiber(root$1, fiber, lane, requestEventTime());
